...
Es gibt insgesamt 10 Lektionen die die Themenkomplexe **Programmierung in R**, **Datenexploration & Visualisierung** and **Statistische Modellierung** umfassen. Jede der Lektione enthält interaktive Quizze und Aufgaben (die nur im Webbrowser funktionieren, nicht in den PDF Dateien).
